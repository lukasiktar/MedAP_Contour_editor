...
class ContourEditor:
    def __init__(self, root: customtkinter.CTk):
        ...
        self.annotator = customtkinter.CTkOptionMenu(button_frame, values=DOCTORS_OPTIONS, command=annotator_menu_callback)
        self.annotator.set(stats['previous_annotator'] if stats['previous_annotator'] else DOCTORS_OPTIONS[0])
